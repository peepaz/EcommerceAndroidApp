...
import com.lilyondroid.lily.activities.ActivityMenuList;
import com.lilyondroid.lily.activities.ActivityMenuListLily;
import com.squareup.picasso.Picasso;

public class AdapterMenuListLily extends BaseAdapter {

		private Activity activity;

		public AdapterMenuListLily(Activity act) {
			this.activity = act;
		}
		
		public int getCount() {
			return ActivityMenuListLily.Menu_name.size();
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.txtText.setText(ActivityMenuListLily.Menu_name.get(position));
